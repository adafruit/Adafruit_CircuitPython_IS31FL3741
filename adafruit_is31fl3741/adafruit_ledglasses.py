...
class Right_Ring:
    ...
    #    (296, 61, 60),  # 23
    #)
    ledmap_bytes = bytearray(
        b'\x01\x1F\x00\x1F\x00\x1E'
        b'\x01\x16\x00\x01\x00\x00'
        b'\x01\x11\x01\x12\x01\x13'
        b'\x01\x1A\x01\x1B\x01\x1C'
        b'\x01\x0E\x01\x0F\x01\x10'
        b'\x00\x1B\x00\x1C\x00\x1D'
        b'\x00\x17\x00\x18\x00\x19'
        b'\x01\x14\x01\x15\x00\x16'
        b'\x00\x14\x00\x15\x00\x1A'
        b'\x00\x32\x00\x33\x00\x38'
        b'\x00\x50\x00\x51\x00\x56'
        b'\x00\x6E\x00\x6F\x00\x74'
        b'\x00\x8C\x00\x8D\x00\x92'
        b'\x00\xAA\x00\xAB\x00\xB0'
        b'\x00\xC8\x00\xC9\x00\xCE'
        b'\x00\xE6\x00\xE7\x00\xEC'
        b'\x01\x04\x01\x05\x01\x0A'
        b'\x01\x5C\x01\x5D\x01\x06'
        b'\x00\xE9\x00\xEA\x00\xEB'
        b'\x00\xED\x00\xEE\x00\xEF'
        b'\x01\x53\x01\x54\x00\xE8'
        b'\x01\x47\x01\x48\x01\x49'
        b'\x01\x31\x00\x5B\x00\x5A'
        b'\x01\x28\x00\x3D\x00\x3C')
...
class Left_Ring:
    ...
    #)
    ledmap_bytes = bytearray(
        b'\x01\x55\x00\xD3\x00\xD2'
        b'\x01\x4C\x00\xB5\x00\xB4'
        b'\x01\x43\x00\x97\x00\x96'
        b'\x00\x7F\x00\x7E\x00\x7D'
        b'\x00\x9A\x00\x99\x00\x98'
        b'\x00\xA3\x00\xA2\x00\xA1'
        b'\x00\xA6\x00\xA5\x00\xA4'
        b'\x00\xF4\x00\xF3\x00\xF2'
        b'\x01\x03\x01\x02\x01\x01'
        b'\x00\xA9\x00\xA8\x00\xA7'
        b'\x00\x8B\x00\x8A\x00\x89'
        b'\x00\x6D\x00\x6C\x00\x6B'
        b'\x00\x4F\x00\x4E\x00\x4D'
        b'\x00\x31\x00\x30\x00\x2F'
        b'\x00\xC7\x00\xC6\x00\xC5'
        b'\x00\xE5\x00\xE4\x00\xE3'
        b'\x00\x13\x00\x12\x00\x11'
        b'\x00\x04\x00\x03\x00\x02'
        b'\x00\x10\x00\x0F\x00\x0E'
        b'\x00\x0D\x00\x0C\x00\x0B'
        b'\x00\x0A\x00\x09\x00\x08'
        b'\x00\xD9\x00\xD8\x00\xD7'
        b'\x00\x07\x00\x06\x00\x05'
        b'\x01\x5E\x00\xF1\x00\xF0')
...
class LED_Glasses(IS31FL3741):
    ...
    @staticmethod
    def pixel_addrs(x, y):
        return unpack_from('>HHH', LED_Glasses.ledmap_bytes,
                           ((y * LED_Glasses.width) + x) * 6)
